                                ...
                                >
                                    <SwiperSlide>
                                        <div className="com">
                                            ...
                                            <div className="name_com d-flex mt-5">
                                                <img src={require('../../../assets/images/ava-1.jpg')} alt="" />
                                                <h5>Ahmed Belal</h5>
                                            </div>
                                        </div>
                                    </SwiperSlide>
                                    ...
                                    <SwiperSlide>
                                        <div className="com">
                                            ...
                                            <div className="name_com d-flex mt-5">
                                                <img src={require('../../../assets/images/ava-2.jpg')} alt="" />
                                                <h5>Ahmed Belal</h5>
                                            </div>
                                        </div>
                                    </SwiperSlide>
                                    ...
                                    <SwiperSlide>
                                        <div className="com">
                                            ...
                                            <div className="name_com d-flex mt-5">
                                                <img src={require('../../../assets/images/ava-3.jpg')} alt="" />
                                                <h5>Ahmed Belal</h5>
                                            </div>
                                        </div>
                                    </SwiperSlide>
                                    ...
                                    <SwiperSlide>
                                        <div className="com">
                                            ...
                                            <div className="name_com d-flex mt-5">
                                                <img src={require('../../../assets/images/ava-4.jpg')} alt="" />
                                                <h5>Ahmed Belal</h5>
                                            </div>
                                        </div>
                                    </SwiperSlide>
