        ...
        <>
            <section className='create_account'>
                <div className="bg_create_account">
                    <img src={require('../../../assets/images/e4c70a70d42588df1e33146f414c4d15 bg.jpg')} alt="" />
                </div>
                            ...
                            <Row>
                                <Col className='p-0' sm='12' md='12' lg='5' xl='5'>
                                    <div className="div_form">
                                        <div className="logo_img">
                                            <img src={require('../../../assets/images/res-logo.png')} alt="" />
                                        </div>
                                ...
                                <Col className='p-0' sm='12' md='12' lg='7' xl='7'>
                                    <div className="bg_img_account">
                                        <img src={require('../../../assets/images/bg_login.jpg')} alt="" />
                                    </div>
                                </Col>
                            </Row>
                        </Container>
